...
from .views import  PageApiviews, SiteSettingsApiviews  , PageContentApiviews , PageContentApiviews
...
urlpatterns = [
    ...
    path('<str:site>/servis-page/', PageContentApiviews.as_view(), name='servis-page-content-list'),
