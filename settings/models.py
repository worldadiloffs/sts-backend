...
class DeliveryService(models.Model):
    ...
    # teskor_buyurtma_dates= models.DateTimeField(blank=True, null=True)
    site_sts = models.BooleanField(default=False, blank=True)
    site_rts = models.BooleanField(default=False, blank=True)
...
class MuddatliTOlov(models.Model):
    name = models.CharField(max_length=200, blank=True, verbose_name=_("Tolov nomi"), unique=True)
    key = models.CharField(max_length=200, blank=True, verbose_name=_("Banking bank_key"))
    foiz  = models.PositiveIntegerField(blank=True, null=True, verbose_name=_("Foiz"))
    logo = models.FileField(upload_to='mudatli_tolov', blank=True)
    status = models.BooleanField(default=False, blank=True)
    site_sts = models.BooleanField(default=False, blank=True)
    site_rts = models.BooleanField(default=False, blank=True)
...
class OylikSettings(models.Model):
    name = models.CharField(max_length=200, blank=True, unique=True)
    muddat_tolov = models.ManyToManyField(MuddatliTOlov, blank=True)
    status = models.BooleanField(default=False, blank=True)
    site_sts = models.BooleanField(default=False, blank=True)
    site_rts = models.BooleanField(default=False, blank=True)
