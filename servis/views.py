...
from .models  import (JopServis, AboutServis, PriceServis, UstanofkaServis, KomandaServis, CategoryServis, LisenceServis, SavolJavobServis, ContactContentServis)


from .serialzier import ( JopServisSerializer  , AboutServisSerializer, PriceServisSerializer, UstanofkaServisSerializer, KomandaServis  , CategoryServisSerializer , LisenceServisSerializer, KomandaServisSerializer, SavolJavobServisSerializer , ContactContentServisSerializer)
