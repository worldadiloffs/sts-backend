from config.settings import PAYCOM_SETTINGS
import base64
from decimal import Decimal

assert PAYCOM_SETTINGS.get('KASSA_ID') != None
assert PAYCOM_SETTINGS.get('ACCOUNTS') != None
assert PAYCOM_SETTINGS['ACCOUNTS'].get('KEY') != None

TOKEN = PAYCOM_SETTINGS['KASSA_ID']
KEY = PAYCOM_SETTINGS['ACCOUNTS']['KEY']
