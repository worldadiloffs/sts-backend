...
class SuperCategoryContent(models.Model):
    title = models.CharField(max_length=200, blank=True)
    text = models.TextField(blank=True)
    images = models.ImageField(upload_to='category/images', blank=True, null=True)
    header_contet = models.CharField(max_length=200, blank=True, null=True)
    supercategory_id = models.OneToOneField(SuperCategory, on_delete=models.SET_NULL, blank=True, null=True)
...
class MainCategory(models.Model):
    superCategory=models.ForeignKey(SuperCategory, on_delete=models.SET_NULL, null=True)
